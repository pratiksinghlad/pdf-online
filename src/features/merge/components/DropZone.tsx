...
export function DropZone() {
  ...
  return (
    <MotionBox
      ...
      tabIndex={0}
      role="button"
      aria-label="Drop PDF, Image, or Text files here or click to select"
      cursor="pointer"
      border="2px dashed"
      ...
      whileTap={{ scale: 0.99 }}
    >
      <input {...getInputProps()} aria-label="Upload PDF or image files" />
      ...
      <VStack gap={3}>
        ...
        <VStack gap={1}>
          ...
          >
            {isDragActive
              ? isDragReject
                ? "Only PDF, Image, and Text files are accepted"
