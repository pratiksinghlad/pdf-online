...
const MergePage = lazy(() =>
  import("./features/merge").then((m) => ({ default: m.MergePage })),
);
const CompressPage = lazy(() =>
  import("./features/compress").then((m) => ({ default: m.CompressPage })),
);
const ImageToPDFPage = lazy(() =>
  import("./features/image-to-pdf").then((m) => ({
    default: m.ImageToPDFPage,
  })),
);
const EncryptPage = lazy(() =>
  import("./features/encrypt").then((m) => ({ default: m.EncryptPage })),
);
const UnlockPage = lazy(() =>
  import("./features/unlock").then((m) => ({ default: m.UnlockPage })),
);
const SplitPDFPage = lazy(() =>
  import("./features/split").then((m) => ({ default: m.SplitPDFPage })),
);
